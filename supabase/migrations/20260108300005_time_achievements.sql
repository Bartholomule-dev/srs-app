-- Add time-based achievement checks to check_achievements RPC
...
COMMENT ON FUNCTION check_achievements IS
  'Idempotent achievement checker. Checks user stats against achievement conditions and unlocks if met.
   ...
   gold-standard, platinum-club, pythonista, century, half-k, thousand-strong, perfect-day,
   early-bird (5-7 AM UTC), night-owl (12-4 AM UTC).';
